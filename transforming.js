...
// console.log(cloudinary.url("dog.jpg", { transformation: { width: 300, height: 300, crop: "thumb", gravity: "auto", fetch_format: "auto", quality: "auto", radius: 50 } }));
...
//         {
//             overlay: {
//                 font_family: "Arial", font_size: 30, text: "Delicious!"
//             }, color: "lime", height: "30", gravity: "south_west", x: 5, y: 5
//         }
//     ]
// }));
// Overlays - Image over video
console.log(cloudinary.url("dog.webm", {
    resource_type: "video", transformation: [{ width: 400, crop: "scale" },
...
console.log(cloudinary.url("dog.webm", {
    ...
    { overlay: "cloudinary_logo", height: "50", gravity: "south_east", x: 10, y: 10 },
    {
        overlay: {
            font_family: "Arial", font_size: 30, text: "Delicious!"
        }, color: "lime", height: "30", gravity: "north_west", x: 5, y: 5
    }
